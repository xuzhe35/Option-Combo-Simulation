...
def build_combo_order_fill_cost_payload(
    ...
    for leg in tracking.get('legs') or []:
        ...
        legs.append({
            ...
            'sourcePosition': leg.get('sourcePosition'),
            'sourceCost': leg.get('sourceCost'),
            'sourceRealizedPnl': leg.get('sourceRealizedPnl') or 0,
            'multiplier': leg.get('multiplier') or '',
...
def build_hedge_order_fill_payload(
    ...
    return {
        ...
        'orderFill': {
            ...
            'deltaPerUnit': tracking.get('deltaPerUnit'),
