    ...
    tests: [
        {
            ...
            run() {
                ...
                for (const [codes, tag] of [['C;O;P', 'ibkr_close_open'],
                    ...
                    const inputs = [
                        activity(`Trades,Data,Order,Equity and Index Options,USD,TQQQ 16OCT26 75 C,"2026-09-16, 10:45:00",-4,1.1,440,-1.7,${codes}`),
                        flex(`U1111111,TQQQ,TQQQ 16OCT26 75 C,OPT,20260916,-4,1.1,440,-1.7,C,75,20261016,100,trade-1,${codes}`),
                    ];
                    for (const input of inputs) {
                        ...
                        assert.equal(parsed.events[0].cashAmount, 438.3);
                    }
                }
            },
        },
